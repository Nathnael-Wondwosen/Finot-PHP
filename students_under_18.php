...
<body class="bg-gray-100">
    <div class="max-w-7xl mx-auto px-4 py-6">
        <div class="mb-6 flex items-center justify-between">
            <h1 class="text-2xl font-semibold">Under 18</h1>
            <div class="flex gap-2">
                ...
                <a href="students_under_18.php" class="px-3 py-1.5 bg-blue-600 text-white border rounded">Under 18</a>
            </div>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Sub City</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200" id="studentsBody">
                    ...
                    <tr data-name="<?= htmlspecialchars(mb_strtolower($s['full_name'] ?? '', 'UTF-8')) ?>" data-phone="<?= htmlspecialchars($s['phone_number'] ?? '') ?>" data-grade="<?= htmlspecialchars($s['current_grade'] ?? '') ?>">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-900"><?= htmlspecialchars($s['sub_city'] ?? '-') ?></td>
                        <td class="px-4 py-3 text-sm text-gray-900"><?= htmlspecialchars($s['district'] ?? '-') ?></td>
...
<?php
// Redirect to dashboard with Under 18 tab and a flag for standalone view
header('Location: dashboard.php?tab=under&view=standalone');
exit;
?>
